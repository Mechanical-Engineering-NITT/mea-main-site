...
export default async function Page({
	...
	if (!user)
		redirect(
			`/?callbackUrl=/study/${params.type}/${params.dept}/${params.course}`,
		);

	const items = [
		{
			name: "Question Papers",
			link: `/study/${params.type}/${params.dept}/${params.course}/qps`,
		},
		{
			name: "Miscellaneous",
			link: `/study/${params.type}/${params.dept}/${params.course}/misc`,
		},
	];
		...
		<>
			...
			<div className=" text-white bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 flex flex-col items-center h-screen w-screen overflow-y-auto px-5 py-10">
				<div className="mt-16 w-full max-w-7xl mx-auto flex items-center relative justify-center">
					<BackButton href={`/study/${params.type}/${params.dept}`} />
